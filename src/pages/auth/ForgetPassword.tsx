...
export default function ForgetPassword() {
    ...
    return (
        <div dir='rtl' className=' bg-[#1B6AF3] h-screen w-full flex justify-center items-center font-["SFArabic-Regular"] relative overflow-hidden'>
            ...
            {/* Login Form Card */}
            <div className='flex flex-col w-[38.6rem] items-center  rounded-4xl bg-gradient-to-t to-[#F2F2F2F2]/95 from-[#F2F2F2]/55 border-white border-[1px] relative z-10'>
                <div className='flex items-center flex-col my-5'>
                    <div className='flex w-full justify-between items-center'>
                        <h1 className='text-[2.4rem]  font-bold my-10'>تغيير كلمه المرور</h1>
                        <div className='w-[4.1rem] h-[4.1rem] bg-white rounded-xl flex justify-center items-center cursor-pointer '>
                            <Link to="/login">
                    ...
                    <button
                        ...
                        disabled={isLoading}
                        className='bg-[#105FE7] my-12 hover:bg-[#1158bb] font-bold duration-200 w-[30.5rem] h-[3.75rem] text-white py-2 px-4 rounded disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2'
                    >
                        {isLoading ? (
                            <>
